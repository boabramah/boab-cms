                                        ...
                                        <tbody>
                                            <?php foreach($this->collection as $transfer):?>
                                                <tr class=" row-<?php echo $transfer->getId();?>">
                                                    ...
                                                    <td style="vertical-align: middle"><?php echo ucFirst($transfer->getStatus());?></td>
                                                    <td style="vertical-align: middle">

                                                        <a href="<?php echo $this->generateDeleteUrl($transfer);?>" class="transfer-cancel" data-transfer-id="<?php echo $transfer->getId();?>">
                                                            <i class="fa fa-cog"></i>
                                                        </a>
                                                    </td>
                                                </tr>
