<div id="funds-funds" class="panel panel-white funds-transfer">
     <div class="panel-heading clearfix align-center">
         <h2 class="panel-title ">Domestic Transfer </h2>
    ...
    <div class="panel-body">
        <form action="[link route_name=transfers_confirm params=transferType:domestic]" method="post">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th colspan="2">Funds transfer between your Accounts and Other Banks <span class="steps">Step 1 of 3</span></th>
                    </tr>
                </thead>                                                
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control input-md" type="text" name="receiver_bank_name" value="">
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">Receiver's Name:</td>
                        <td>
                            <input class="form-control input-md" type="text" name="receiver_name" value="">
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">Receiver's Account Number:</td>
                        <td>
                            <input class="form-control input-sm" type="text" name="receiver_account_name" value="">
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">SWIFT/ABA Routing Number:</td>
                        <td>
                            <input class="form-control input-sm" type="text" name="routing_number" value="">
                        </td>
                    </tr>                                                                                
                    <tr>
